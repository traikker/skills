...
Create `issues.md`. For each approved slice, add a new issue-template into `issues.md`. Use the issue body template below.
...
#<parent-issue-number> (otherwise omit this section if no parent exists)
...
Make first issue more vertical
